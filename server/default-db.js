...
function makeDefaultDb() {
  ...
  const cashierHash = bcrypt.hashSync('cash123', 10);
  return {
    users: [
      {
        id: 'u_admin',
    ...
    settings: {
      ...
      repairLookupFallbackEnabled: true,
      repairSheetUpdateWebAppUrl: '',
      repairSheetUpdateToken: '',
      repairSheetAutoUpdateEnabled: true,
