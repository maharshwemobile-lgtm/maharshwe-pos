  ...
  return (
    <section className="credit-page">
      <div className="credit-page-heading">
        <div><span className="credit-eyebrow">PHASE 3 · CUSTOMER CREDIT</span><h2>Customers & Credit</h2><p>Customer profile၊ credit balance၊ payment collection နဲ့ sale history ကို workflow တစ်ခုတည်းအဖြစ် ချိတ်ဆက်စီမံပါ။</p></div>
